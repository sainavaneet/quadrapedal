...
parser = argparse.ArgumentParser(description="This script to import go2 robot")
...
def run_simulator(sim: sim_utils.SimulationContext, entities: dict[str, Articulation], origins: torch.Tensor):
    ...
    while simulation_app.is_running():
        ...
        for robot in entities.values():
            ...
            joint_pos_target = robot.data.default_joint_pos + torch.randn_like(robot.data.joint_pos) * 0.05
